...
<!--            <input type="hidden" name="_token" value=-->
                                    ...
                                    <div class="form-group">
                                        <label class="sr-only" for="exampleInputPassword2" placeholder="Enter your password">Password</label>
                                        <input type="password" class="form-control" name="password" id="password" placeholder="Enter password"/>
                                    </div>

                                    <input class="btn" placeholder="Sign In" type="submit" value="Sign In" onclick="formhash(this.form, this.form.password)"/>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-3">
                ...
                <a href="#"><img src={{URL::asset('images/twitter.png')}} alt="facebook"></a>
                <a href="#"><img src={{URL::asset('images/linkedin.png')}} alt="facebook"></a>
                <a href="#"><img src={{URL::asset('images/instagram.png')}} alt="facebook"></a>
            </div>
